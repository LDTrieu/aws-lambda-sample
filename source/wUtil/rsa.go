...
// func RSASignMessage(message string, signKey *rsa.PrivateKey) (signature string, err error) {
// 	h := sha256.New()
// 	h.Write([]byte(message))
// 	d := h.Sum(nil)
// 	sig, err := rsa.SignPKCS1v15(rand.Reader, signKey, crypto.SHA256, d)
// 	if err != nil {
// 		return "", err
// 	}
...
// func RSAVerifySignature(sig string, message string, verifyKey *rsa.PublicKey) error {
// 	h := sha256.New()
// 	h.Write([]byte(message))
// 	d := h.Sum(nil)
...
// 		return err
// 	}
// 	return rsa.VerifyPKCS1v15(verifyKey, crypto.SHA256, d, sigBytes)
// }
